...
/*
  ...
  Parameters:
    ...
    Input, float X, the argument of the CDF.

    Output, float CDF, the value of the CDF.
*/
{
...
float normal_01_cdf_inv ( float p )
...
/*
  ...
  Parameters:
    ...
    Input, float P, the value of the cumulative probability
    densitity function.  0 < P < 1.  If P is outside this range, an
    "infinite" value is returned.

    Output, float NORMAL_01_CDF_INV, the normal deviate value
...
/*
  ...
  Parameters:
    ...
    Output, float NORMAL_01_MEAN, the mean of the PDF.
*/
{
  float mean;
...
/*
  ...
  Parameters:
    ...
    Output, float NORMAL_01_MOMENT, the value of the moment.
*/
{
  float value;
...
/*
  ...
  Parameters:
    ...
    Input, float X, the argument of the PDF.

    Output, float NORMAL_01_PDF, the value of the PDF.
*/
{
  float pdf;
...
/*
  ...
  Parameters:
    ...
    Output, float NORMAL_01_VARIANCE, the variance of the PDF.
*/
{
  float variance;
...
/*
  ...
  Parameters:
    ...
    Input, float MU, SIGMA, the parameters of the PDF.
    0.0 < SIGMA.

    Output, float NORMAL_MS_CDF, the value of the CDF.
*/
{
  float cdf;
  float y;
...
/*
  ...
  Parameters:
    ...
    Input, float CDF, the value of the CDF.
    0.0 <= CDF <= 1.0.

    Input, float MU, SIGMA, the parameters of the PDF.
    0.0 < SIGMA.

    Output, float NORMAL_MS_CDF_INV, the corresponding argument.
*/
{
  float x;
  float x2;
...
/*
  ...
  Parameters:
    ...
    Output, float NORMAL_MS_MEAN, the mean of the PDF.
*/
{
  float mean;
...
/*
  ...
  Parameters:
    ...
    Input, float MU, the mean of the distribution.

    Input, float SIGMA, the standard deviation of the distribution.

    Output, float NORMAL_MS_MOMENT, the value of the central moment.
*/
{
  int j;
  int j_hi;
...
/*
  ...
  Parameters:
    ...
    Output, float NORMAL_MS_MOMENT_CENTRAL, the value of the central moment.
*/
{
  float value;
...
/*
  ...
  Parameters:
    ...
    Output, float NORMAL_MS_MOMENT_CENTRAL_VALUES, the value of the central moment.
*/
{
  float value;
...
/*
  ...
  Parameters:
    ...
    Output, float NORMAL_MS_MOMENT_VALUES, the value of the central moment.
*/
{
  float value;
...
/*
  ...
  Parameters:
    ...
    Output, float NORMAL_MS_PDF, the value of the PDF.
*/
{
  float pdf;
  const float r8_pi = 3.14159265358979323;
...
/*
  ...
  Parameters:
    ...
    Output, float NORMAL_MS_SAMPLE, a sample of the PDF.
*/
{
  float x;
...
/*
  ...
  Parameters:
    ...
    Output, float NORMAL_MS_VARIANCE, the variance of the PDF.
*/
{
  float variance;
...
/*
  ...
  Parameters:
    ...
    Output, float R8_CHOOSE, the number of combinations of N
...
/*
  ...
  Parameters:
    ...
    Output, float R8_HUGE, a "huge" real value.
*/
{
  return HUGE_VAL;
}
...
/*
  ...
  Parameters:
    ...
    Input, float *RVEC, a pointer to the first entry of the array.
...
/*
  ...
  Parameters:
    ...
    Output, float R8VEC_MIN, the value of the minimum element.  This
    is set to 0.0 if N <= 0.
*/
{
  int i;
...
/*
  ...
  Parameters:
    ...
    Input, float MU, SIGMA, the mean and standard deviation of the
    parent Normal distribution.

    Input, float A, B, the lower and upper truncation limits.

    Output, float TRUNCATED_NORMAL_AB_CDF, the value of the CDF.
*/
{
  float alpha;
  float alpha_cdf;
...
/*
  ...
  Parameters:
    ...
    Output, float *MU, the mean of the distribution.

    Output, float *SIGMA, the standard deviation of the distribution.

    Output, float *A, *B, the lower and upper truncation limits.
...
float truncated_normal_ab_cdf_inv ( float cdf, float mu, float sigma, 
  float a, float b )
...
/*
  ...
  Parameters:
    ...
    Input, float MU, S, the mean and standard deviation of the
    parent Normal distribution.

    Input, float A, B, the lower and upper truncation limits.

    Output, float TRUNCATED_NORMAL_AB_CDF_INV, the corresponding argument.
*/
{
  float alpha;
  float alpha_cdf;
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_AB_MEAN, the mean of the PDF.
*/
{
  float alpha;
  float alpha_cdf;
...
float truncated_normal_ab_moment ( int order, float mu, float sigma, 
  float a, float b )
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_AB_MOMENT, the moment of the PDF.
*/
{
  float a_h;
  float a_cdf;
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_AB_PDF, the value of the PDF.
*/
{
  float alpha;
  float alpha_cdf;
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_AB_SAMPLE, a sample of the PDF.
*/
{
  float alpha;
  float alpha_cdf;
...
float truncated_normal_ab_variance ( float mu, float sigma, float a, 
  float b )
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_AB_VARIANCE, the variance of the PDF.
*/
{
  float alpha;
  float alpha_cdf;
...
/*
  ...
  Parameters:
    ...
    Input, float A, the lower truncation limit.

    Output, float TRUNCATED_NORMAL_A_CDF, the value of the CDF.
*/
{
  float alpha;
  float alpha_cdf;
...
/*
  ...
  Parameters:
    ...
    Output, float *A, the lower truncation limit.
...
float truncated_normal_a_cdf_inv ( float cdf, float mu, float sigma, 
  float a )
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_A_CDF_INV, the corresponding argument.
*/
{
  float alpha;
  float alpha_cdf;
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_A_MEAN, the mean of the PDF.
*/
{
  float alpha;
  float alpha_cdf;
...
float truncated_normal_a_moment ( int order, float mu, float sigma, 
  float a )
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_A_MOMENT, the moment of the PDF.
*/
{
  float moment;
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_A_PDF, the value of the PDF.
*/
{
  float alpha;
  float alpha_cdf;
...
float truncated_normal_a_sample ( float mu, float sigma, float a, 
  int *seed )
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_A_SAMPLE, a sample of the PDF.
*/
{
  float alpha;
  float alpha_cdf;
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_A_VARIANCE, the variance of the PDF.
*/
{
  float alpha;
  float alpha_cdf;
...
/*
  ...
  Parameters:
    ...
    Input, float B, the upper truncation limit.

    Output, float TRUNCATED_NORMAL_B_CDF, the value of the CDF.
*/
{
  float beta;
  float beta_cdf;
...
/*
  ...
  Parameters:
    ...
    Output, float *B, the upper truncation limit.
...
float truncated_normal_b_cdf_inv ( float cdf, float mu, float sigma, 
  float b )
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_B_CDF_INV, the corresponding argument.
*/
{
  float beta;
  float beta_cdf;
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_B_MEAN, the mean of the PDF.
*/
{
  float beta;
  float beta_cdf;
...
float truncated_normal_b_moment ( int order, float mu, float sigma, 
  float b )
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_B_MOMENT, the moment of the PDF.
*/
{
  float f;
  float h;
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_B_PDF, the value of the PDF.
*/
{
  float beta;
  float beta_cdf;
...
float truncated_normal_b_sample ( float mu, float sigma, float b, 
  int *seed )
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_B_SAMPLE, a sample of the PDF.
*/
{
  float beta;
  float beta_cdf;
...
/*
  ...
  Parameters:
    ...
    Output, float TRUNCATED_NORMAL_B_VARIANCE, the variance of the PDF.
*/
{
  float beta;
  float beta_cdf;
...
int log_normal_truncated_ab_check ( float mu, float sigma, float a, 
  float b )
...
/*
  ...
  Parameters:
    ...
    Output, int LOG_NORMAL_TRUNCATED_AB_CHECK, is true if the parameters 
    are legal.
*/
{
  int check;
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "LOG_NORMAL_TRUNCATED_AB_CHECK - Fatal error!\n" );
    fprintf ( stderr, "  SIGMA <= 0.\n" );
    check = 0;
  }
...
float log_normal_pdf ( float x, float mu, float sigma )
...
/*
  ...
  Parameters:
    ...
    Output, float PDF, the value of the PDF.
*/
{
  float pdf;
  const float r8_pi = 3.14159265358979323;
...
float log_normal_cdf ( float x, float mu, float sigma )
...
/*
  ...
  Parameters:
    ...
    Output, float LOG_NORMAL_TRUNCATED_AB_PDF, the value of the PDF.
*/
{
  int check;
  float lncdf_a;
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "LOG_NORMAL_TRUNCATED_AB_PDF - Fatal error!\n" );
    fprintf ( stderr, "  Parameters are not legal.\n" );
    exit ( 1 );
  }
