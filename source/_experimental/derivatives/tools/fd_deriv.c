...
{
	float GRAD[data.Nth];	// 1st derivatives
	float sGRAD[data.Nth];	// 1st derivatives
	float HES[data.Nth][data.Nth];	// hessian
	float sHES[data.Nth][data.Nth];	// hessian
	float X[data.Nth];
	int i, j;
	float t1, t2;
