...
#endif
//	if (curgen_db->entry[pos].point == NULL) curgen_db->entry[pos].point = malloc(tmcmc_data.data.Nth*sizeof(float));
	if (curgen_db->entry[pos].point == NULL) curgen_db->entry[pos].point = malloc(dim*sizeof(float));
