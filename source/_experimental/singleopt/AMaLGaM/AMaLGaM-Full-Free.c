...
void installedProblemEvaluation( int index, float *parameters, float *objective_value, float *constraint_value );
void installedProblemEvaluationWithoutRotation( int index, float *parameters, float *objective_value, float *constraint_value );
void rosenbrockFunctionProblemEvaluation( float *parameters, float *objective_value, float *constraint_value );
